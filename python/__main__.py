...
if __name__ == "__main__":
    try:
        ...
        Sistema_A_SQL = pd.read_csv("D:\\Dropbox\\cursos\\soul-code\\3-tarefas\\atividades\\atividade-16\\Sistema_A_SQL.csv", sep=",")
        Sistema_B_NoSQL = pd.read_csv("D:\\Dropbox\\cursos\\soul-code\\3-tarefas\\atividades\\atividade-16\\Sistema_B_NoSQL.csv", sep=",")
        ...
        interface_mysql = Interface_db_mysql("robson","R0350njose*123","127.0.0.1","OldTech_Ltda") 
